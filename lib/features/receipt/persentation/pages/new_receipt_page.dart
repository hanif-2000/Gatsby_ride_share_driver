                      ...
                      Row(
                        children: [
                          CustomCacheNetworkImage(
                              img: provider.receiptData!.image, size: 50),
                          // Container(
                          //   height: 50,
                          //   width: 50,
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                provider.receiptData!.customerRating.toString(),
                                textAlign: TextAlign.center,
                                style: titleStyle
                                    .copyWith(
                                      fontSize: 14,
                            ...
                            Text(
                              DateFormat.yMMMd().format(
                                  (DateFormat("yyyy-MM-dd HH:mm:ss").parse(
                                          provider.receiptData!.orderTime
                                              .toString(),
                                          true))
                                      .toLocal()),
                              // DateFormat.yMMMd()
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              '${provider.receiptData!.actualTime ?? 0} min',
                              textAlign: TextAlign.center,
                              style: titleStyle
                                  .copyWith(
                                    fontSize: 16,
                                  ...
                                  showModalBottomSheet(
                                    ...
                                    builder: (context) {
                                      return PaymentScreen(
                                          ...
                                          grandTotal:
                                              provider.receiptData!.total,
                                          distance: provider.receiptData!.distance
                                              .toString());
                                    },
                                  );
                                },
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  getPaymentType(
                                      provider.receiptData!.paymentMethod),
                                  textAlign: TextAlign.center,
                                  style: titleStyle
                                      .copyWith(fontSize: 16, color: grey7D7979)
                                      .usePoppinsW5Font(),
                                ),
                              ],
                            ),
                          ...
                          showDialog(
                            ...
                            builder: (context) {
                              return AlertDialog(
                                ...
                                title: const Text("Please Confirm Payment"),
                                content: const Text(
